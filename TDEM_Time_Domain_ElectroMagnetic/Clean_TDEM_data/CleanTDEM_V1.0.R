# Hello! This script reads a raw data file from TEM-FAST instrument, a TDEM (Time-domain electromagnetic method) instrument.
...
#Paschetto, A., Vergnano, A., Caselle, C., Comina, C., Benente, L., Bono, E., Fenoglio, T.M., Fontanella, F., Vianello, D., Bonetto, S.M.R., 2025. Integration of TDEM and HVSR surveys for water resources investigation in arid regions: The case of Horombe plateau, Madagascar. Journal of Applied Geophysics 241, 105872. https://doi.org/10.1016/j.jappgeo.2025.105872


##Release notes:
#1.0 December 2025. Polished, Changed name to CleanTDEM, updated suggested citation.
...
fwrite(rawdata_selected,sprintf("output/%s_.csv",basename(element)),row.names=FALSE,scipen=50)
