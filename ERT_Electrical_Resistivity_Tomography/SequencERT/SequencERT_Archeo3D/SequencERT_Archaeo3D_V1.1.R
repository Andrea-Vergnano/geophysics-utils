### SequencERT_Archaeo3D_V1.1.R ###

## Release notes ##
# V1.0 2024: creation of this script.
# V1.1 December 2025: Updated introduction and file output
...
# Vergnano, A., Franco, D., Merico, A., Pace, F., Uggè, S., Comina, C., 2025. Survey and Sequence Strategies for Full‐3D Electrical Resistivity Tomography in Archaeological Sites: A Case Study on a Domus of the Roman Town of Augusta Bagiennorum (NW Italy). Archaeological Prospection arp.70013. https://doi.org/10.1002/arp.70013
...
colnames(sequ_txt)[1]="#"
write.table(sequ_txt,sprintf("output/Grid_%ix%i.txt",m,n),row.names = FALSE,quote=FALSE,sep="\t",append=TRUE)
